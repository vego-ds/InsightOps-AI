...
InsightOps-AI is a production-style sales analytics automation platform that validates uploaded sales CSVs, computes KPIs, detects security risks and anomalies, generates deterministic executive insights, and produces audit-ready API responses and report artifacts.
...
- Built a FastAPI sales analytics platform that validates CSV data, computes KPIs, detects anomalies, and returns typed audit-ready analysis responses.
...
InsightOps-AI is a production-style sales analytics automation API with deterministic validation, KPI computation, security guardrails, anomaly detection, executive insights, report artifacts, CI, Docker support, and a lightweight static dashboard.
