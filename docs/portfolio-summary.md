...
- Built a FastAPI sales analytics platform that validates CSV data, tracks source metadata and lineage, gates analysis confidence, computes KPIs, ties visual analytics to recommendations, generates workflow improvements, detects anomalies, and returns typed audit-ready analysis responses.
